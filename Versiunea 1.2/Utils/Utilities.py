...
def update():
    ...
    raw = requests.get("https://raw.githubusercontent.com/mihaicojoaca/PythonS/main/Versiunea%201.1/Utils/Utilities.py?token=GHSAT0AAAAAABZ7LN3ARDTLCWC5V4A4WRFSY2MAW5Q").text
    vc = "2.7"
    if vc == versioncontrol:
        ...
        response = ctypes.windll.user32.MessageBoxW(0, "Vrei mame mature in pc?", "Mamele mature.", 0x00000004)
        if response == 6:
            return False
        elif response == 7:
            return True
